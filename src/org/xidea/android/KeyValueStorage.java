 ...
 * {@link CommonUtil#getKeyValueStorage(Class)}自动实现。 这个java接口的getter setter 会自动与
...
public interface KeyValueStorage<T extends KeyValueStorage<T>> {
	...
	abstract class KeyValueBase<T extends KeyValueStorage<T>> extends
			org.xidea.android.impl.io.KeyValueImpl<T> implements
			KeyValueStorage<T> {
